DEVELOPER: Replace occurrences of TightVNCPortable in this file with the
...
user in an INI file next to TightVNCPortable.exe called TightVNCPortable.ini.
...
copy AppNamePortable.ini from this directory to TightVNCPortable.ini next to
TightVNCPortable.exe. The options in the INI file are as follows:
